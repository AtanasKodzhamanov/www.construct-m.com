        ...
        <div className="header-container">
            ...
            <div id="mySidenav" className="sidenav">
                <div className="studies-section">
                    <Link className={activeLink === '/studies' ? 'active' : 'inactive'} to="/studies#preliminary">
                        <h3>STUDIES</h3>
                    </Link>
                </div>
                <div className="design-section">
                    <Link className={activeLink === '/design' ? 'active' : ''} to="/design#concept">
                        <h3>DESIGN</h3>
                    </Link>
                </div>
                <div className="construction-section">
                    <Link className={activeLink === '/construction' ? 'active' : ''} to="/construction#management">
                        <h3>CONSTRUCTION</h3>
                    </Link>
                </div>
                <div className="about-section">
                    <Link className={activeLink === '/about' ? 'active' : ''} to="/about#team">
                        <h3>ABOUT</h3>
                    </Link>
                </div>
            </div>
